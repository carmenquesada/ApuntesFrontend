...
# Delete Modal and HTTP DELETE Request for removing Restaurants
...
2. Implement the needed elements in RestaurantsScreen.js. 
...
# Edit Form and HTTP PUT Request for editing Restaurants
...
2. Modify the onPress action of the Edit Pressable at the renderRestaurantof the RestaurantsScreen.js component to navigate to this edit screen including the id of the restaurant. You can use the following:
...
# Implement Edit and Delete of Products
